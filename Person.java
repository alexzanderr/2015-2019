 ...
 */
package olderProjects.SUPREME_FOLDER;

import java.util.Objects;

/**
 * This class contains general data about persons. This is made by Andrew.
 *
 * @author Andrew
 */
public class Person implements Comparable<Object> {
     ...
     *
     * @param params final String firstName, final String secondName, final int
     ...
     * @return
     */
    public static Person Instantiation(final String name) {
     ...
     * @return
     */
    public static Person Instantiation(final String name, final int age) {
