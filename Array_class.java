...
import Andrew_s_Field.FUNCTIONS;
...
public class Array_class {
    ...
    private Array_class(final int[] array) {
        this.array = array;
    }
    ...
    private void Print_array_average(Array_class obj) {
    ...
    private void Prime_numbers_and_indexs(Array_class obj) {
        for (int _index = 0; _index < obj.array.length; _index++) {
            if (FUNCTIONS.Prime_number(obj.array[_index])) {
    ...
    public static void main(String[] args) {
        Array_class array = new Array_class(new int[]{1, 2, 3, 4, 5, 6, 7});
...
//        array.Find_subArray(new int[]{3, 4, 5});
        Array_class vector = new Array_class(new int[Generate_length_random(50, 50)]);
